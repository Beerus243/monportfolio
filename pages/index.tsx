  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Fabrice Malanga est Un développeur web et web mobile de Kinshasa-RD Congo. Fabrice, un développeur fullstack, peut concevoir des systèmes informatiques, développer des solutions web, des applications mobiles et bien plus. "
        />
